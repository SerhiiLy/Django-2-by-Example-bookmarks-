...
# Функция create_action() позволяет создать активность и связать ее с некото-
# рым объектом target, если он будет передан в качестве аргумента. Мы будем
# использовать данную функцию для большего удобства при создании записи об
